A web application to generate and discover music featuring artists who are also performing at various music festivals.

This project uses MERN.io to scaffold the project, making it easy to build isomorphic apps using MongoDB, Express, React and NodeJS. It minimizes the setup time and gets you up to speed using proven technologies.

## Quickstart

Create local .env file and populate the following keys in this format
...
The index.js file simply does client side rendering using the data provided from `window.__INITIAL_STATE__`.
